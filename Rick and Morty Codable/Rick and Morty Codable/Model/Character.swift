...
struct TopLevelDictonary: Decodable {
    // Using coding keys to match the API, I changed results to characters becasue it makes me since and since we are using result in our fetch, it wont have any issues when creating it.
